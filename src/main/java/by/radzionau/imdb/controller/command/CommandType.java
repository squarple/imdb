...
public enum CommandType {
    ...
    MOVE_TO_TOP_METHODS, RESULTS_OF_PAIRED_COMPARISONS, /*METHOD_OF_WEIGHING_ASSESSMENTS,*/
    RESULTS_OF_WEIGHING_ASSESSMENTS,
    MOVE_TO_METHOD_OF_PAIRED_COMPARISONS, /*GET_TOP_PAIRED_COMPARISONS,*/
